...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#534f4f1e", padding: 20 },
  ...
  timeValue: { marginLeft: 8, fontSize: 16, fontWeight: "600" },
  ...
  durationText: { fontWeight: "700", fontSize: 16, color: "#333" },
