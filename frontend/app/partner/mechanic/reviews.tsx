...
const REVIEWS = [
    { id: '1', user: 'Kasun D.', rating: 5, comment: 'Very fast service! Arrived in 10 mins and fixed my battery.', date: '2 days ago' },
    { id: '2', user: 'Dilshan M.', rating: 4, comment: 'Good mechanic, but price was a bit high.', date: '1 week ago' },
    { id: '3', user: 'Sarah K.', rating: 5, comment: 'Lifesaver! My car broke down in the middle of nowhere.', date: '2 weeks ago' },
];
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={styles.ratingOverview}>
                    <View style={styles.scoreContainer}>
                        ...
                        <Text style={styles.totalReviews}>24 Reviews</Text>
                    </View>
...
const styles = StyleSheet.create({
    ...
    ratingOverview: { flexDirection: 'row', padding: 20, alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#1F1F1F', margin: 20, borderRadius: 16, borderWidth: 1, borderColor: '#333' },
    scoreContainer: { alignItems: 'center', paddingRight: 20, borderRightWidth: 1, borderRightColor: '#333' },
    ...
    card: { backgroundColor: '#161616', borderRadius: 16, padding: 20, marginBottom: 15, borderWidth: 1, borderColor: '#333' },
