    ...
    const Bar = ({ day, height, active }: any) => (
        <View style={{ alignItems: 'center', gap: 5 }}>
            <View style={{ height: 100, width: 30, justifyContent: 'flex-end', backgroundColor: '#222', borderRadius: 15 }}>
                <View style={{ width: '100%', height: (height + '%') as any, backgroundColor: active ? '#2962FF' : '#444', borderRadius: 15 }} />
            </View>
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <ScrollView contentContainerStyle={styles.content}>
                    ...
                    <View style={styles.totalCard}>
                        <Text style={styles.totalLabel}>Total Revenue (This Month)</Text>
                        <Text style={styles.totalValue}>LKR 450,250</Text>
                        <View style={styles.growTag}>
                            <Ionicons name="arrow-up" size={12} color="#FFF" />
                            <Text style={styles.growText}>+8.5%</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.grid}>
                        <StatCard label="Total Services" value="48" color="#FFF" />
                        <StatCard label="New Customers" value="12" color="#00C851" />
                        <StatCard label="Pending" value="5" color="#FFD700" />
                        <StatCard label="Cancelled" value="1" color="#FF4444" />
                    </View>
...
const styles = StyleSheet.create({
    ...
    growText: { color: '#FFF', fontSize: 12, fontWeight: 'bold' },
    ...
    statCard: { width: (width - 55) / 2, backgroundColor: '#101018', padding: 20, borderRadius: 16, borderWidth: 1, borderColor: '#222' },
