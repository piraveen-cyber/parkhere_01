...
export default function LightVehicle() {
    ...
    const services = [
        { id: 'towing', title: 'Towing Service', price: '5000', icon: 'tow-truck', lib: MaterialCommunityIcons },
        { id: 'battery', title: 'Battery Jumpstart', price: '3000', icon: 'battery-charging', lib: MaterialCommunityIcons },
        { id: 'tire', title: 'Flat Tire Change', price: '2500', icon: 'disc', lib: Ionicons },
        { id: 'fuel', title: 'Fuel Delivery', price: '2000', icon: 'gas-pump', lib: FontAwesome5 },
        { id: 'engine', title: 'Engine Check', price: '4000', icon: 'engine', lib: MaterialCommunityIcons },
        { id: 'lockout', title: 'Car Lockout', price: '3500', icon: 'key', lib: Ionicons },
    ...
    const handleRequest = async () => {
        ...
        try {
            ...
            if (selectedService === 'others') {
                // Route to Issue Selector for manual selection
                router.push({
                ...
                // Skip Issue Selector and go straight to Service Type
                // Pass the selected service as the implied "issue"
                router.push({
                    ...
                    params: {
                        ...
                        price: selectedItem?.price,
                        serviceName: selectedItem?.title,
                        issues: JSON.stringify([selectedItem?.title]) // Auto-select the issue
                    }
                });
            }
