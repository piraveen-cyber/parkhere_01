...
export default function EV() {
    ...
    const services = [
        { id: 'charge', title: 'Express Charging', price: '1200', icon: 'flash', lib: Ionicons },
        { id: 'battery_swap', title: 'Battery Replacement', price: '4000', icon: 'battery-charging-full', lib: MaterialCommunityIcons },
        { id: 'sw_update', title: 'Software Diagnostics', price: '2000', icon: 'laptop-code', lib: FontAwesome5 },
        { id: 'port_check', title: 'Port Maintenance', price: '1500', icon: 'power-plug', lib: MaterialCommunityIcons },
    ];
    ...
    const handleRequest = async () => {
        ...
        try {
            ...
            await api.post('/services', {
                ...
                notes: `Requested EV Service: ${selectedItem?.title}`,
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: bg }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, { color: textPrimary }]}>EV Assistance</Text>
            </View>
            ...
            <ScrollView contentContainerStyle={{ padding: 20 }}>
                ...
                <Text style={{ color: textSecondary, marginBottom: 20 }}>Charging and tech support for your EV.</Text>
            ...
            {selectedService && (
                <Animated.View style={[styles.footer, { opacity: fadeAnim }]}>
                    <Pressable style={[styles.btn, { backgroundColor: accent }]} onPress={handleRequest}>
                        <Text style={styles.btnText}>REQUEST EV SERVICE</Text>
